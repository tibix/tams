         ...
         <article class="relative lg:sticky lg:top-8 lg:w-1/2">
             ...
             <div class="mt-6 md:align-middle">
                 <a href="category.html"
                     class="transition-color relative text-sm font-medium uppercase tracking-widest text-red-700 duration-300 ease-in-out hover:text-red-600">Technology</a>
                 ...
                 <div class="mt-4 flex items-center sm:mt-8">
                     <a href="author.html" class="h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                         <img data-src="images/author-01.jpeg"
         ...
         <div class="mt-12 sm:mt-16 lg:ml-12 lg:mt-0 lg:w-1/2 xl:ml-16">
             ...
             <div class="grid lg:grid-cols-2 lg:gap-x-5 xl:grid-cols-1">
                 ...
                 <article class="py-8 sm:flex lg:flex-col xl:flex-row xl:items-center">
                     <!-- Image -->
                     <a href="post.html" class="order-2 w-full sm:w-2/5 lg:order-1 lg:w-full xl:w-2/5">
                         <div
                             class="group aspect-h-9 aspect-w-16 relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                             <img data-src="images/recent-01.jpeg"
                     ...
                     <div
                         ...
                         <div class="mt-4 flex items-center justify-between">
                             ...
                             <div class="flex items-center justify-center">
                                 <a href="author.html" class="mr-3 animate-pulse rounded-lg bg-gray-50">
                                     <img class="lazy h-6 w-6 flex-shrink-0 rounded-lg object-cover object-center opacity-0 transition duration-300 ease-in-out"
                                         data-src="images/author-02.jpeg" alt="Author 01" />
                                 </a>
                                 <div class="text-sm">
                                     <span class="text-gray-500">By </span>
                                     <a class="font-medium text-gray-700 hover:underline" href="author.html">Taylor
                                         Adams</a>
                 ...
                 <article
                     ...
                     <a href="post.html" class="order-2 w-full sm:w-2/5 lg:order-1 lg:w-full xl:w-2/5">
                         <div
                             class="group aspect-h-9 aspect-w-16 relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                             <img data-src="images/recent-02.jpeg"
                                 class="lazy rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110" />
                         </div>
                     </a>
                     ...
                     <div
                         ...
                         <div class="mt-4 flex items-center justify-between">
                             ...
                             <div class="flex items-center justify-center">
                                 <a href="author.html" class="mr-3 animate-pulse rounded-lg bg-gray-50">
                                     <img class="lazy h-6 w-6 flex-shrink-0 rounded-lg object-cover object-center opacity-0 transition duration-300 ease-in-out"
                                         data-src="images/author-03.jpeg" alt="Author 01" />
                                 </a>
                                 <div class="text-sm">
                                     <span class="text-gray-500">By </span>
                                     <a class="font-medium text-gray-700 hover:underline" href="author.html">Matt
                                         Burgess</a>
                                     <span class="text-gray-500 lg:hidden xl:inline-block">
                                         · Feb 2, 2022</span>
                                 </div>
                 ...
                 <!-- 3rd Article -->
                 <article class="border-t border-gray-300/70 py-8 sm:flex lg:flex-col xl:flex-row xl:items-center">
                     <!-- Image -->
                     <a href="post.html" class="order-2 w-full sm:w-2/5 lg:order-1 lg:w-full xl:w-2/5">
                         <div
                             class="group aspect-h-9 aspect-w-16 relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                             <img data-src="images/recent-03.jpeg"
                                 class="lazy rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110" />
                         </div>
                     </a>
                     ...
                     <div
                         ...
                         <div class="mt-4 flex items-center justify-between">
                             ...
                             <div class="flex items-center justify-center">
                                 <a href="author.html" class="mr-3 animate-pulse rounded-lg bg-gray-50">
                                     <img class="lazy h-6 w-6 flex-shrink-0 rounded-lg object-cover object-center opacity-0 transition duration-300 ease-in-out"
                                         data-src="images/author-04.jpeg" alt="Author 01" />
                                 </a>
                                 <div class="text-sm">
                                     <span class="text-gray-500">By </span>
                                     <a class="font-medium text-gray-700 hover:underline" href="author.html">Amit
                                         Katwala</a>
                                     <span class="text-gray-500 lg:hidden xl:inline-block">
                                         · Nov 2, 2020</span>
                                 </div>
                 ...
                 <article class="border-t border-gray-300/70 py-8 sm:flex lg:flex-col xl:flex-row xl:items-center">
                     ...
                     <a href="post.html" class="order-2 w-full sm:w-2/5 lg:order-1 lg:w-full xl:w-2/5">
                         <div
                             class="group aspect-h-9 aspect-w-16 relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                             <img data-src="images/recent-04.jpeg"
                                 class="lazy rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110" />
                         </div>
                     </a>
                     ...
                     <div
                         ...
                         <div class="mt-4 flex items-center justify-between">
                             ...
                             <div class="flex items-center justify-center">
                                 <a href="author.html" class="mr-3 animate-pulse rounded-lg bg-gray-50">
                                     <img class="lazy h-6 w-6 flex-shrink-0 rounded-lg object-cover object-center opacity-0 transition duration-300 ease-in-out"
                                         data-src="images/author-05.jpeg" alt="Author 01" />
                                 </a>
                                 <div class="text-sm">
                                     <span class="text-gray-500">By </span>
                                     <a class="font-medium text-gray-700 hover:underline" href="author.html">Amanda
                                         Lewis</a>
                                     <span class="text-gray-500 lg:hidden xl:inline-block">
                                         · Feb 22, 2022</span>
                                 </div>
                 ...
                 <article class="border-t border-gray-300/70 py-8 sm:flex lg:flex-col xl:flex-row xl:items-center">
                     ...
                     <a href="post.html" class="order-2 w-full sm:w-2/5 lg:order-1 lg:w-full xl:w-2/5">
                         <div
                             class="group aspect-h-9 aspect-w-16 relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                             <img data-src="images/recent-05.jpeg"
                                 class="lazy rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110" />
                         </div>
                     </a>
                     ...
                     <div
                         ...
                         <div class="mt-4 flex items-center justify-between">
                             ...
                             <div class="flex items-center justify-center">
                                 <a href="author.html" class="mr-3 animate-pulse rounded-lg bg-gray-50">
                                     <img class="lazy h-6 w-6 flex-shrink-0 rounded-lg object-cover object-center opacity-0 transition duration-300 ease-in-out"
                                         data-src="images/author-06.jpeg" alt="Author 01" />
                                 </a>
                                 <div class="text-sm">
                                     <span class="text-gray-500">By </span>
                                     <a class="font-medium text-gray-700 hover:underline" href="author.html">Karina
                                         Bell</a>
                                     <span class="text-gray-500 lg:hidden xl:inline-block">
                                         · Feb 19, 2022</span>
                                 </div>
                 ...
                 <article class="border-t border-gray-300/70 py-8 sm:flex lg:flex-col xl:flex-row xl:items-center">
                     ...
                     <a href="post.html" class="order-2 w-full sm:w-2/5 lg:order-1 lg:w-full xl:w-2/5">
                         <div
                             class="group aspect-h-9 aspect-w-16 relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                             <img data-src="images/recent-06.jpeg"
                                 class="lazy rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110" />
                         </div>
                     </a>
                     ...
                     <div
                         ...
                         <div class="mt-4 flex items-center justify-between">
                             ...
                             <div class="flex items-center justify-center">
                                 <a href="author.html" class="mr-3 animate-pulse rounded-lg bg-gray-50">
                                     <img class="lazy h-6 w-6 flex-shrink-0 rounded-lg object-cover object-center opacity-0 transition duration-300 ease-in-out"
                                         data-src="images/author-07.jpeg" alt="Author 01" />
                                 </a>
                                 <div class="text-sm">
                                     <span class="text-gray-500">By </span>
                                     <a class="font-medium text-gray-700 hover:underline" href="author.html">Veronica
                                         Mars</a>
                                     <span class="text-gray-500 lg:hidden xl:inline-block">
                                         · Feb 22, 2022</span>
                                 </div>
