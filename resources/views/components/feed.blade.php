    ...
    <div class="w-full lg:grid lg:grid-cols-3 lg:gap-8">
        ...
        <div class="col-span-2">
            ...
            <a href="#"
                ...
                <img data-src="images/banner-ad.jpeg"
            ...
            <div
                ...
                <article
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3
                                ...
                                <a href="post.html">
                                    ...
                                    <span class="sr-only">How to increase conversion with design</span>
                                </a>
                            </h3>
                        ...
                        <div class="mt-5 flex items-center sm:mt-6">
                            <a href="author.html" class="relative h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                                <img data-src="images/author-02.jpeg"
                ...
                <article
                    ...
                    <div
                        ...
                        <div class="mt-5 flex items-center sm:mt-6">
                            <a href="author.html" class="relative h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                                <img data-src="images/author-03.jpeg"
                                    class="lazy h-full w-full rounded-xl object-cover object-center opacity-0 transition duration-300 ease-in-out" />
                            </a>
                            <div class="ml-3">
                                <a href="author.html"
                ...
                <article
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3
                                ...
                                <a href="post.html">
                                    ...
                                    <span class="sr-only">The Best way to get Free Advertising</span>
                                </a>
                            </h3>
                        ...
                        <div class="mt-5 flex items-center sm:mt-6">
                            <a href="author.html" class="relative h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                                <img data-src="images/author-04.jpeg"
                                    class="lazy h-full w-full rounded-xl object-cover object-center opacity-0 transition duration-300 ease-in-out" />
                            </a>
                            <div class="ml-3">
                                <a href="author.html"
                ...
                <article
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3
                                ...
                                <a href="post.html">
                                    ...
                                    <span class="sr-only">The Latest Tech that will Grow your Business</span>
                                </a>
                            </h3>
                        ...
                        <div class="mt-5 flex items-center sm:mt-6">
                            <a href="author.html" class="relative h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                                <img data-src="images/author-05.jpeg"
                                    class="lazy h-full w-full rounded-xl object-cover object-center opacity-0 transition duration-300 ease-in-out" />
                            </a>
                            <div class="ml-3">
                                <a href="author.html"
                ...
                <article
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3
                                ...
                                <a href="post.html">
                                    ...
                                    <span class="sr-only">How to Iterate Faster and Work Less</span>
                                </a>
                            </h3>
                        ...
                        <div class="mt-5 flex items-center sm:mt-6">
                            <a href="author.html" class="relative h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                                <img data-src="images/author-06.jpeg"
                                    class="lazy h-full w-full rounded-xl object-cover object-center opacity-0 transition duration-300 ease-in-out" />
                            </a>
                            <div class="ml-3">
                                <a href="author.html"
                ...
                <article
                    ...
                    <div
                        ...
                        <div class="mt-5 flex items-center sm:mt-6">
                            <a href="author.html" class="relative h-10 w-10 animate-pulse rounded-xl bg-gray-50">
                                <img data-src="images/author-07.jpeg"
                                    class="lazy h-full w-full rounded-xl object-cover object-center opacity-0 transition duration-300 ease-in-out" />
                            </a>
                            <div class="ml-3">
                                <a href="author.html"
                ...
                <div class="space-y-6 pt-6 sm:space-y-5 lg:space-y-6 xl:space-y-5">
                    ...
                    <article class="flex space-x-4 sm:space-x-6 lg:space-x-4">
                        ...
                        <a href="post.html"
                            ...
                            <img data-src="images/trending-01.jpeg"
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-sm">
                                            ...
                                            <a class="font-medium text-gray-700 hover:underline"
                                                href="author.html">Micheal Osman</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <article class="flex space-x-4 sm:space-x-6 lg:space-x-4">
                        ...
                        <a href="post.html"
                            class="group relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                            <img data-src="images/trending-02.jpeg"
                                class="lazy h-24 w-24 rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110 sm:h-28 sm:w-28 lg:h-20 lg:w-20 xl:h-24 xl:w-24" />
                        </a>
                                ...
                                <div class="mt-2 flex items-center justify-between">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-sm">
                                            <span class="text-gray-500">By </span>
                                            <a class="font-medium text-gray-700 hover:underline"
                                                href="author.html">Brenda Reinink</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <article class="flex space-x-4 sm:space-x-6 lg:space-x-4">
                        ...
                        <a href="post.html"
                            class="group relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                            <img data-src="images/trending-03.jpeg"
                                class="lazy h-24 w-24 rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110 sm:h-28 sm:w-28 lg:h-20 lg:w-20 xl:h-24 xl:w-24" />
                        </a>
                                ...
                                <div class="mt-2 flex items-center justify-between">
                                    <div class="flex items-center justify-center">
                                        <div class="text-sm">
                                            <span class="text-gray-500">By </span>
                                            <a class="font-medium text-gray-700 hover:underline"
                                                href="author.html">Ava Sanchez</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <article class="flex space-x-4 sm:space-x-6 lg:space-x-4">
                        ...
                        <a href="post.html"
                            class="group relative z-10 animate-pulse overflow-hidden rounded-2xl bg-gray-100">
                            <img data-src="images/trending-04.jpeg"
                                class="lazy h-24 w-24 rounded-2xl object-cover object-center opacity-0 transition duration-300 ease-in-out group-hover:scale-110 sm:h-28 sm:w-28 lg:h-20 lg:w-20 xl:h-24 xl:w-24" />
                        </a>
            ...
            <div class="mt-8 w-full rounded-2xl bg-gray-50 p-5 sm:p-8">
                ...
                <div class="pt-5">
                    <div class="overflow-hidden">
                        <!-- Twitter -->
                        <a href="#" class="group flex w-full items-center justify-between">
                ...
                <div class="pt-6">
                    <div class="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-4">
                        ...
                        <div
                            ...
                            <a href="#" class="absolute inset-0 z-10 h-full w-full rounded-2xl shadow-md"></a>
