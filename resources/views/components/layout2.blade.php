			...
			<div class="flex w-full items-center justify-between">
				...
				<div class="flex shrink-0 items-center">
					<a href="{{route('index')}}" class="lg:hidden">
                        <i class="fa fa-newspaper-o h-9 w-auto bg-red-700 text-white text-2xl font-bold py-1 px-4 rounded-full">
                        </i> <span class="text-2xl text-bold">TAMS</span>
					</a>
				...
				<!-- Search -->
				<div class="relative ml-3 h-10 w-full max-w-xxs rounded-3xl">
                ...
                <div class="ml-6 hidden items-center justify-between text-xl md:flex md:space-x-0.5 md:text-base lg:space-x-2">
                    @auth
                        <span class="font-bold uppercase">Welcome {{auth()->user()->u_name}}</span>
		...
		<div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
			...
			<div class="sm:flex sm:items-center sm:justify-between">
				...
				<div class="flex items-center justify-center">
                    <a href="{{route('index')}}" class="lg:block">
                        <i class="fa fa-newspaper-o h-9 w-auto bg-red-700 text-white text-2xl font-bold py-1 px-4 rounded-full">
                        </i> <span class="text-2xl text-bold">TAMS</span>
                    </a>
				</div>
