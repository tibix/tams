...
Route::get('/users/password_reset_form', [UserController::class, 'password_reset_form'])->middleware('auth');
Route::put('/users/password_reset', [UserController::class, 'password_reset'])->middleware('auth');
